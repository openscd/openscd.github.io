...
import { html, internalProperty, property, query, } from '../../_snowpack/pkg/lit-element.js';
...
export function Logging(Base) {
    ...
    ], LoggingElement.prototype, "currentAction", void 0);
    __decorate([
        property()
    ...
    __decorate([
        query('#diagnostic')
    ], LoggingElement.prototype, "diagnosticUI", void 0);
    __decorate([
        query('#error')
    ], LoggingElement.prototype, "errorUI", void 0);
    __decorate([
        query('#warning')
    ], LoggingElement.prototype, "warningUI", void 0);
    __decorate([
        query('#info')
    ], LoggingElement.prototype, "infoUI", void 0);
    __decorate([
        query('#issue')
    ], LoggingElement.prototype, "issueUI", void 0);
