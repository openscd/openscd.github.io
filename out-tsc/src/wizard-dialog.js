...
import { customElement, css, queryAll, LitElement, property, internalProperty, html, } from '../../_snowpack/pkg/lit-element.js';
import { get, translate } from '../../_snowpack/pkg/lit-translate.js';
import { Dialog } from '../../_snowpack/pkg/@material/mwc-dialog.js';
import '../../_snowpack/pkg/ace-custom-element.js';
import './wizard-textfield.js';
import { newActionEvent, newWizardEvent, wizardInputSelector, isWizard, checkValidity, reportValidity, identity, } from './foundation.js';
...
let WizardDialog = class WizardDialog extends LitElement {
    ...
    async act(action, primary = true) {
        ...
        wizardActions.forEach(wa => isWizard(wa)
