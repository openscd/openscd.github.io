...
import { isCreateOptions, selectors, startMove, updateNamingAction, } from './foundation.js';
...
let ConductingEquipmentEditor = ConductingEquipmentEditor_1 = class ConductingEquipmentEditor extends LitElement {
    ...
    static wizard(options) {
        const [heading, actionName, actionIcon, action, name, desc, reservedNames,] = isCreateOptions(options)
            ? [
            ...
            : [
                ...
                Array.from(options.element.parentNode.querySelectorAll(selectors.ConductingEquipment))
