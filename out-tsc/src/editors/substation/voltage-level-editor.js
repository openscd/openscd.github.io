...
import { createElement, getMultiplier, getReference, getValue, newActionEvent, newWizardEvent, patterns, } from '../../foundation.js';
import { isCreateOptions, selectors, startMove, styles, cloneElement, } from './foundation.js';
...
let VoltageLevelEditor = VoltageLevelEditor_1 = class VoltageLevelEditor extends LitElement {
    ...
    static wizard(options) {
        const [heading, actionName, actionIcon, action, name, desc, nomFreq, numPhases, Voltage, multiplier,] = isCreateOptions(options)
            ? [
