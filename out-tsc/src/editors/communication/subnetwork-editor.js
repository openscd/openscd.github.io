...
import { newWizardEvent, newActionEvent, getValue, getMultiplier, patterns, compareNames, createElement, getReference, } from '../../foundation.js';
...
export function subNetworkWizard(options) {
    const [heading, actionName, actionIcon, action, name, desc, type, BitRate, multiplier,] = isCreateOptions(options)
        ? [
