import { OrthogonalConnector, } from '../../../public/js/ortho-connector.js';
import { identity } from '../../foundation.js';
import { getIcon } from '../../zeroline/foundation.js';
import { connectivityNodeIcon, powerTransformerTwoWindingIcon, } from '../../icons.js';
import { getRelativeCoordinates, getDescriptionAttribute, getNameAttribute, getAbsoluteCoordinates, calculateConnectivityNodeCoordinates, } from './foundation.js';
/**
...
export function createTerminalElement(elementPosition, sideToDraw, terminalElement, clickAction) {
    ...
    const terminalIdentity = typeof identity(terminalElement) === 'string'
        ? identity(terminalElement)
        : 'unidentifiable';
