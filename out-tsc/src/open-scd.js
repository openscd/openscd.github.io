...
import { newLogEvent, newPendingStateEvent, newWizardEvent, } from './foundation.js';
...
let OpenSCD = class OpenSCD extends Setting(Wizarding(Waiting(Validating(Plugging(Editing(Logging(LitElement))))))) {
    constructor() {
        super();
    ...
    get menu() {
        ...
        return [
            ...
            },
            {
                ...
                name: 'menu.validate',
                action: () => this.doc
                    ? this.dispatchEvent(newPendingStateEvent(this.validate(this.doc, { fileName: this.docName })))
                    : null,
                disabled: () => this.doc === null,
            },
            {
...
__decorate([
    query('#saveas')
], OpenSCD.prototype, "saveUI", void 0);
OpenSCD = __decorate([
